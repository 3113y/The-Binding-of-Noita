...
TBoN_MOD:AddCallback(TBoN.Callback.TBON_POST_PICKUP_MAGIC,TBoN_MOD.Open_Challenge)
TBoN_MOD:AddCallback(TBoN.Callback.TBON_POST_PICKUP_WAND,TBoN_MOD.Open_Challenge)