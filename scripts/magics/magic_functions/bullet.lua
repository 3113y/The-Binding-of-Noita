...
TBoN_MOD:AddCallback(ModCallbacks.MC_POST_EFFECT_UPDATE, TBoN_MOD.Bullet_Damage, TBoN.Magic.Table.Info.Variant.Bullet)
--消失逻辑
...
TBoN_MOD:AddCallback(ModCallbacks.MC_POST_EFFECT_UPDATE, TBoN_MOD.Bullet_Disappear, TBoN.Magic.Table.Info.Variant.Bullet)
