--动画逻辑
function TBoN_MOD:Ice_Ball_Animation(entity)
...
TBoN_MOD:AddCallback(ModCallbacks.MC_POST_EFFECT_INIT, TBoN_MOD.Ice_Ball_Animation, TBoN.Magic.Table.Info.Variant.Ice_Ball)
--伤害逻辑
function TBoN_MOD:Ice_Ball_Damage(entity)
    print("Ice Ball Update")
    ...
    if #entities > 0 then
        ...
        entities[1]:AddFreeze(EntityRef(entity), 60)
        -- 触发回调并移除投射物
...
TBoN_MOD:AddCallback(ModCallbacks.MC_POST_EFFECT_UPDATE, TBoN_MOD.Ice_Ball_Damage, TBoN.Magic.Table.Info.Variant.Ice_Ball)
--消失逻辑
function TBoN_MOD:Ice_Ball_Disappear(entity)
...
TBoN_MOD:AddCallback(ModCallbacks.MC_POST_EFFECT_UPDATE, TBoN_MOD.Ice_Ball_Disappear, TBoN.Magic.Table.Info.Variant.Ice_Ball)
