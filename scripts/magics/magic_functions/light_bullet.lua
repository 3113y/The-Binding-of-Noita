...
TBoN_MOD:AddCallback(ModCallbacks.MC_POST_EFFECT_UPDATE, TBoN_MOD.Light_Bullet_Damage, TBoN.Magic.Table.Info.Variant.Light_Bullet)
--消失逻辑
...
TBoN_MOD:AddCallback(ModCallbacks.MC_POST_EFFECT_UPDATE, TBoN_MOD.Light_Bullet_Disappear, TBoN.Magic.Table.Info.Variant.Light_Bullet)
