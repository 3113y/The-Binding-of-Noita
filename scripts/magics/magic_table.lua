...
TBoN.Magic.Table.bag_magic_data = {
    ...
    {magic_id = "BULLET_TIMER", current_uses = -1, max_uses = -1},
    ...
    {magic_id = "HEAVY_BULLET_TRIGGER", current_uses = -1, max_uses = -1},
    {magic_id = "HEAVY_BULLET_TIMER", current_uses = -1, max_uses = -1},
    {magic_id = "TELEPORT_PROJECTILE_SHORT", current_uses = -1, max_uses = -1},
    {magic_id = "HOMING_SHORT", current_uses = -1, max_uses = -1},
    {magic_id = "BLACK_HOLE", current_uses = -1, max_uses = -1},
    {magic_id = "BLACK_HOLE_DEATH_TRIGGER", current_uses = -1, max_uses = -1},
