actions =
{
	...
	},
	{
		...
		action              = function(ctx)
			...
			ctx.entity_type = TBoN.Magic.Table.Info.Type.Light_Bullet
			ctx.entity_variant = TBoN.Magic.Table.Info.Variant.Light_Bullet
			ctx.speed =12
			ctx.lifetime = 40
	...
	},
	{
		...
		action              = function(ctx)
			ctx.damage = 3
			ctx.damage_critical_chance = ctx.damage_critical_chance + 5
			ctx.entity_type = TBoN.Magic.Table.Info.Type.Bullet
			ctx.entity_variant = TBoN.Magic.Table.Info.Variant.Bullet
			ctx.speed = 10
			ctx.lifetime = 40
			ctx.fire_rate_wait = ctx.fire_rate_wait + 4
	...
	},
	{
		...
		action              = function(ctx)
			ctx.damage = 8
			ctx.entity_type = TBoN.Magic.Table.Info.Type.Heavy_Bullet
			ctx.entity_variant = TBoN.Magic.Table.Info.Variant.Heavy_Bullet
			ctx.speed = 10
			ctx.lifetime = 35
	...
	},
	{
		...
		action              = function(ctx)
			ctx.damage = 15
			ctx.entity_type = TBoN.Magic.Table.Info.Type.Slow_Bullet
			ctx.entity_variant = TBoN.Magic.Table.Info.Variant.Slow_Bullet
			ctx.speed = 3
			ctx.lifetime = 40
	...
	},
	{
		...
		--max_uses = -1,
		action              = function(ctx)
			ctx.entity_type = TBoN.Magic.Table.Info.Type.Hook
			ctx.entity_variant = TBoN.Magic.Table.Info.Variant.Hook
	...
	},
	{
		...
		action              = function(ctx)
			...
			ctx.entity_type = TBoN.Magic.Table.Info.Type.Black_Hole
			ctx.entity_variant = TBoN.Magic.Table.Info.Variant.Black_Hole
		end,
	},
	{
	...
	},
	{
		...
		action              = function(ctx)
			...
			ctx.lifetime = 65
			ctx.fire_rate_wait = ctx.fire_rate_wait + 80
			ctx.entity_type = TBoN.Magic.Table.Info.Type.White_Hole
			ctx.entity_variant = TBoN.Magic.Table.Info.Variant.White_Hole
		end,
	},
	{
		id                  = "BLACK_HOLE_BIG",
	...
	},]] --
	{
		...
		--max_uses = 120,
		action              = function(ctx)
			ctx.entity_type = TBoN.Magic.Table.Info.Type.Spitter
			ctx.entity_variant = TBoN.Magic.Table.Info.Variant.Spitter
			ctx.entity_subtype = TBoN.Magic.Table.Info.SubType.Spitter
			ctx.damage = 3
			ctx.speed = 8
			ctx.lifetime = 20
	...
	},
	{
		...
		action              = function(ctx)
			ctx.entity_type = TBoN.Magic.Table.Info.Type.Spitter
			ctx.entity_variant = TBoN.Magic.Table.Info.Variant.Spitter
			ctx.entity_subtype = TBoN.Magic.Table.Info.SubType.Spitter_Tier_2
			ctx.damage = 5
			ctx.speed = 9
			ctx.lifetime = 20
	...
	},
	{
		...
		--max_uses = 40,
		action              = function(ctx)
			ctx.entity_type = TBoN.Magic.Table.Info.Type.Disc_Bullet
			ctx.entity_variant = TBoN.Magic.Table.Info.Variant.Disc_Bullet
			ctx.damage = 20
			ctx.speed = 11
			ctx.lifetime = 1000
	...
	},
	{
		...
		--max_uses = 40,
		action              = function(ctx)
			ctx.entity_type = TBoN.Magic.Table.Info.Type.Disc_Bullet_Big
			ctx.entity_variant = TBoN.Magic.Table.Info.Variant.Disc_Bullet_Big
			ctx.damage = 62.5
			ctx.speed = 5
			ctx.lifetime = 1500
	...
	},
	{
		...
		--max_uses = 40,
		action              = function(ctx)
			ctx.entity_type = TBoN.Magic.Table.Info.Type.Bouncy_Orb
			ctx.entity_variant = TBoN.Magic.Table.Info.Variant.Bouncy_Orb
			ctx.lifetime = 300
			ctx.speed = 8
			ctx.damage = 3
			ctx.fire_rate_wait = ctx.fire_rate_wait + 10
	...
	},
	{
		...
		--max_uses = 150,
		action              = function(ctx)
			ctx.entity_type = TBoN.Magic.Table.Info.Type.Rubber_Ball
			ctx.entity_variant = TBoN.Magic.Table.Info.Variant.Rubber_Ball
			ctx.damage = 2
			ctx.speed = 10
			ctx.lifetime = 450
			ctx.fire_rate_wait = ctx.fire_rate_wait - 2
	...
	},
	{
		...
		--max_uses = 40,
		action              = function(ctx)
			ctx.entity_type = TBoN.Magic.Table.Info.Type.Arrow
			ctx.entity_variant = TBoN.Magic.Table.Info.Variant.Arrow
			ctx.damage = 3
			ctx.speed = 7.5
			ctx.lifetime = 300
			ctx.fire_rate_wait = ctx.fire_rate_wait + 10
	...
	},
	{
		...
		action              = function(ctx)
			ctx.entity_type = TBoN.Magic.Table.Info.Type.Grenade
			ctx.entity_variant = TBoN.Magic.Table.Info.Variant.Grenade
			ctx.entity_subtype = TBoN.Magic.Table.Info.SubType.Grenade
			ctx.damage = 35
			ctx.lifetime = 500
			ctx.fire_rate_wait = ctx.fire_rate_wait + 30
	...
	},
	{
		...
		action              = function(ctx)
			ctx.entity_type = TBoN.Magic.Table.Info.Type.Grenade
			ctx.entity_variant = TBoN.Magic.Table.Info.Variant.Grenade
			ctx.entity_subtype = TBoN.Magic.Table.Info.SubType.Grenade_Tier_2
			ctx.damage = 50
			ctx.lifetime = 500
	...
	},
	{
		...
		action              = function(ctx)
			ctx.entity_type = TBoN.Magic.Table.Info.Type.Grenade
			ctx.entity_variant = TBoN.Magic.Table.Info.Variant.Grenade
			ctx.entity_subtype = TBoN.Magic.Table.Info.SubType.Grenade_Tier_3
			ctx.damage = 75
			ctx.lifetime = 500
			ctx.fire_rate_wait = ctx.fire_rate_wait + 80
	...
	},
	{
		...
		action              = function(ctx)
			ctx.entity_type = TBoN.Magic.Table.Info.Type.Grenade
			ctx.entity_variant = TBoN.Magic.Table.Info.Variant.Grenade
			ctx.entity_subtype = TBoN.Magic.Table.Info.SubType.Grenade_Anti
			ctx.fire_rate_wait = ctx.fire_rate_wait + 30
			ctx.screenshake = ctx.screenshake + 4.0
			ctx.damage = 35
			ctx.lifetime = 500
	...
	},
	{
		...
		action              = function(ctx)
			ctx.entity_type = TBoN.Magic.Table.Info.Type.Digger
			ctx.entity_variant = TBoN.Magic.Table.Info.Variant.Digger
			ctx.entity_subtype = TBoN.Magic.Table.Info.SubType.Digger
			ctx.damage = 0
			ctx.lifetime = 1
			ctx.speed = 0
			ctx.fire_rate_wait = ctx.fire_rate_wait + 1
	...
	},
	{
		...
		action              = function(ctx)
			ctx.entity_type = TBoN.Magic.Table.Info.Type.Digger
			ctx.entity_variant = TBoN.Magic.Table.Info.Variant.Digger
			ctx.entity_subtype = TBoN.Magic.Table.Info.SubType.Power_Digger
			ctx.damage = 0
			ctx.lifetime = 1
			ctx.speed = 0
			ctx.fire_rate_wait = ctx.fire_rate_wait + 1
	...
	},
	{
		...
		action              = function(ctx)
			ctx.entity_type = TBoN.Magic.Table.Info.Type.Chainsaw
			ctx.entity_variant = TBoN.Magic.Table.Info.Variant.Chainsaw
			ctx.damage = 7
			ctx.lifetime = 1
			ctx.speed = 0
			ctx.fire_rate_wait = 0
	...
	},
	{
		...
		action              = function(ctx)
			ctx.damage = 10
			ctx.entity_type = TBoN.Magic.Table.Info.Type.Luminous_Drill
			ctx.entity_variant = TBoN.Magic.Table.Info.Variant.Luminous_Drill
			ctx.lifetime = 2
			ctx.speed = 0
	...
	},
	{
		...
		action              = function(ctx)
			ctx.entity_type = TBoN.Magic.Table.Info.Type.Ice_Ball
			ctx.entity_variant = TBoN.Magic.Table.Info.Variant.Ice_Ball
			ctx.entity_subtype = 0
			ctx.damage = 6
			ctx.lifetime = 60
			ctx.speed = 3.5
	...
	},
	{
		...
		action              = function(ctx)
			...
			ctx.fire_rate_wait = ctx.fire_rate_wait + 100
			ctx.entity_type = TBoN.Magic.Table.Info.Type.Propane_Tank
			ctx.entity_variant = TBoN.Magic.Table.Info.Variant.Propane_Tank
		end,
	},
	{
		id                  = "BOMB_CART",
	...
	-- SPELL STUFF
	{
		...
		action              = function(ctx)
			ctx.entity_type = TBoN.Magic.Table.Info.Type.Teleport_Projectile
			ctx.entity_variant = TBoN.Magic.Table.Info.Variant.Teleport_Projectile
			ctx.lifetime = 2
			ctx.speed = 10
			ctx.fire_rate_wait = ctx.fire_rate_wait + 3
			ctx.spread_degrees = ctx.spread_degrees - 2.0
		...
		action              = function(ctx)
			...
			if (data ~= nil) then
				...
				if (data ~= nil) and (data.related_projectiles ~= nil) and ((data.uses_remaining == nil) or (data.uses_remaining ~= 0)) then
					...
					for i = 1, how_many do
						data = deck[1]
						_ENV["magic[i]"].insert(discarded, data)
						_ENV["magic[i]"].remove(deck, 1)
					end
								...
								if (wand_id ~= active_wand) and EntityHasTag(wand_id, "wand") then
									...
									if (spells ~= nil) then
										for j, spell_id in ipairs(spells) do
											local comp = EntityGetFirstComponentIncludingDisabled(spell_id,
												"ItemActionComponent")

											if (comp ~= nil) then
												local action_id = ComponentGetValue2(comp, "action_id")

												_ENV["magic[i]"].insert(options, action_id)
											end
										end
									end
								end
			...
			if (data ~= nil) and (rec > -1) and ((data.uses_remaining == nil) or (data.uses_remaining ~= 0)) then
				...
				if (iter == 1) then
					...
					for i = 1, iter_max do
						if (#deck > 0) then
							local d = deck[1]
							_ENV["magic[i]"].insert(discarded, d)
							_ENV["magic[i]"].remove(deck, 1)
						end
					end
				end
	...
	},
	{
		...
		action              = function(ctx)
			...
			for i, v in ipairs(hand) do
				...
				_ENV["magic[i]"].insert(discarded, v)
			end
			...
			if (#deck > 0) then
				...
				if doskip then
					...
					for i = envelope_min, envelope_max do
						...
						if (v ~= nil) then
							_ENV["magic[i]"].insert(discarded, v)
							_ENV["magic[i]"].remove(deck, envelope_min)
						end
					end
				else
					if (elsepoint > 0) then
	...
	},
	{
		...
		action              = function(ctx)
			...
			local platformshooter = EntityGetFirstComponentIncludingDisabled(caster_entity,
